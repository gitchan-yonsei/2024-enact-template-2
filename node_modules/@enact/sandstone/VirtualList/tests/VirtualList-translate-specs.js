...
describe('VirtualList with translate \'scrollMode\'', function () {
  var clientSize, dataSize, getScrollTo, handlerOnScroll, handlerOnScrollStart, handlerOnScrollStop, items, itemSize, myScrollTo, onScrollCount, onScrollStartCount, onScrollStopCount, renderItem, resultScrollLeft, resultScrollTop, startScrollTop;
  beforeEach(function () {
    clientSize = {
      clientWidth: 1280,
      clientHeight: 720
  ...
  describe('ScrollTo', function () {
    ...
    test('should scroll to the given \'align\' with scrollTo', function (done) {
      var onScrollStop = handlerOnScrollStop(done, function () {
        var expected = dataSize * itemSize - clientSize.clientHeight + 30;
    ...
    test('should scroll to the given \'align\' with scrollTo after changing \'dataSize\'', function (done) {
      var newDataSize = 50;
      var onScrollStop = handlerOnScrollStop(done, function () {
        var expected = newDataSize * itemSize - clientSize.clientHeight + 30;
        var actual = resultScrollTop;
        expect(actual).toBe(expected);
      });
    ...
    test('should scroll to the given \'align\' with scrollTo after changing \'itemSize\'', function (done) {
      var newItemSize = 50;
      var onScrollStop = handlerOnScrollStop(done, function () {
        var expected = dataSize * newItemSize - clientSize.clientHeight + 30;
        var actual = resultScrollTop;
        expect(actual).toBe(expected);
      });
      var _render3 = (0, _react.render)( /*#__PURE__*/(0, _jsxRuntime.jsx)(_VirtualList["default"], {
          cbScrollTo: getScrollTo,
          clientSize: clientSize,
          dataSize: dataSize,
          itemRenderer: renderItem,
    ...
    test('should scroll to the given \'align\' with scrollTo after changing \'spacing\'', function (done) {
      var newSpacing = 30;
      var onScrollStop = handlerOnScrollStop(done, function () {
        var expected = dataSize * (itemSize + newSpacing) - clientSize.clientHeight - newSpacing + 30;
        var actual = resultScrollTop;
        expect(actual).toBe(expected);
      });
      var _render4 = (0, _react.render)( /*#__PURE__*/(0, _jsxRuntime.jsx)(_VirtualList["default"], {
          cbScrollTo: getScrollTo,
          clientSize: clientSize,
          dataSize: dataSize,
          itemRenderer: renderItem,
  ...
  describe('Adding an item', function () {
    test('should render an added item named \'Password 0\' as the first item', function (done) {
      ...
      var _render5 = (0, _react.render)( /*#__PURE__*/(0, _jsxRuntime.jsx)(_VirtualList["default"], {
          clientSize: clientSize,
