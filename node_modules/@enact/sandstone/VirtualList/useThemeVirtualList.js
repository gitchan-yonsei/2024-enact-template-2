...
var useSpottable = function useSpottable(props, instances) {
  ...
  if (props.dataSize !== mutableRef.current.dataSize) {
    var _Spotlight$getCurrent;
    var focusedIndex = (_Spotlight$getCurrent = _spotlight["default"].getCurrent()) === null || _Spotlight$getCurrent === void 0 || (_Spotlight$getCurrent = _Spotlight$getCurrent.dataset) === null || _Spotlight$getCurrent === void 0 ? void 0 : _Spotlight$getCurrent.index;
    if (focusedIndex > props.dataSize - 1) {
  ...
  function focusByIndex(index, direction, waiting) {
    ...
    if (!itemNode && index >= 0 && index < props.dataSize) {
      ...
      var current = _spotlight["default"].getCurrent(),
        candidate = current ? (0, _target.getTargetByDirectionFromElement)(direction, current) : itemNode;
