 ...
 * @private
 */
var ColorPickerBase = (0, _kind["default"])({
  name: 'ColorPicker',
  functional: true,
...
var ColorPickerDecorator = (0, _compose["default"])(_Skinnable["default"], (0, _Toggleable["default"])({
  prop: 'popupOpen',
 ...
 * @private
 */
exports.ColorPickerDecorator = ColorPickerDecorator;
var ColorPicker = ColorPickerDecorator(ColorPickerBase);
