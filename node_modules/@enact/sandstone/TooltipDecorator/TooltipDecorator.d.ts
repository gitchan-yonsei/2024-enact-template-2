// Type definitions for sandstone/TooltipDecorator
...
Spotlight-outset (24px) margin/padding value which keeps elements and text aligned inside a
  . Note: This value will be scaled according to the
resolution.
 */
 ...
 */
  ...
  /**
   * Type of tooltip.
   * _Value_ _Tooltip Appearance_ `'balloon'` Tooltip with a border, background and arrow to the activator `'transparent'` Text only without any of the decorations above */
...
export class TooltipBase extends React.Component<
  Merge<React.HTMLProps<HTMLElement>, TooltipBaseProps>
> {}
...
export class Tooltip extends React.Component<
  Merge<React.HTMLProps<HTMLElement>, TooltipProps>
> {}
