...
exports.timeToLocaleString = exports["default"] = void 0;
...
var dateTimeConfig = {
  ...
  i18n: function i18n() {
    ...
    var order = getLabelFormatter().getTemplate().replace(/'.*?'/g, '').match(filter).map(function (s) {
...
var TimePicker = (0, _Pure["default"])((0, _Skinnable["default"])((0, _DateTime.DateTimeDecorator)(dateTimeConfig, _TimePickerBase["default"])));
...
var timeToLocaleString = function timeToLocaleString(time) {
  if (!time) {
    return null;
  }
  return getLabelFormatter().format(time);
};
exports.timeToLocaleString = timeToLocaleString;
