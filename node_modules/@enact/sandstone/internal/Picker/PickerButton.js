...
exports["default"] = exports.PickerButtonBase = exports.PickerButton = void 0;
...
var _excluded = ["disabled", "icon"],
  _excluded2 = ["disabled", "icon", "joined"];
...
var PickerButtonBase = (0, _kind["default"])({
  name: 'PickerButton',
  contextType: _MarqueeController.MarqueeControllerContext,
  propTypes: {
    disabled: _propTypes["default"].bool,
    icon: _propTypes["default"].oneOfType([_propTypes["default"].string, _propTypes["default"].object]),
  ...
  render: function render(_ref2) {
    ...
    if (joined) {
      ...
      return /*#__PURE__*/(0, _jsxRuntime.jsx)(JoinedPickerButton, _objectSpread(_objectSpread({}, rest), {}, {
        icon: icon,
        disabled: disabled
      }));
    } else {
